...
function validatePractcalAssign(practicalAssign, method) {
    ...
    return method.toUpperCase() == "POST" ? schemaForInsert.validate(practicalAssign) : schemaForUpdate.validate(practicalAssign);
}

exports.validate = validatePractcalAssign;